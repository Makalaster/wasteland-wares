...
public class GetAllArmorThread extends AsyncTask<Void, Void, List<Item>> {
    private RecyclerView mRecyclerView;
    private WaresRecyclerAdapter mWaresRecyclerAdapter;
    private WaresRecyclerAdapter.OnItemSelectedListener mListener;

    public GetAllArmorThread(RecyclerView recyclerView, WaresRecyclerAdapter waresRecyclerAdapter, WaresRecyclerAdapter.OnItemSelectedListener listener) {
