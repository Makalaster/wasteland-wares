...
public class GetAllMiscThread extends AsyncTask<Void, Void, List<Item>> {
    private RecyclerView mRecyclerView;
    private WaresRecyclerAdapter mWaresRecyclerAdapter;
    private WaresRecyclerAdapter.OnItemSelectedListener mListener;

    public GetAllMiscThread(RecyclerView recyclerView, WaresRecyclerAdapter waresRecyclerAdapter, WaresRecyclerAdapter.OnItemSelectedListener listener) {
